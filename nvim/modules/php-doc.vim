...
if !exists('g:pdv_cfg_Author') | let g:pdv_cfg_Author = "Sheena Muhammad Ali Zien <sheenazien8@gmail.com>" | endif
if !exists('g:pdv_cfg_Copyright') | let g:pdv_cfg_Copyright = strftime('%Y') . " sheenazien8" | endif
if !exists('g:pdv_cfg_License') | let g:pdv_cfg_License = " {@link http://www.php.net/license/}" | endif
